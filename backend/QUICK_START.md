...
## Testing the System (After Server Starts)

### Run Full Pipeline Validation Tests
```bash
...
### What Gets Tested
✓ 5 diverse internship scenarios (legitimate, scam, startup, suspicious, borderline)
✓ All 6 validation pipelines per test case
✓ Dataset validation, company verification, sentiment analysis, and more
✓ Generates detailed JSON report

### Expected Output
```
Running test 1/5: Google (Legitimate)
...
### Find More Details
👉 See [TESTING_INDEX.md](TESTING_INDEX.md) for complete testing documentation
👉 See [PIPELINE_TESTING_GUIDE.md](PIPELINE_TESTING_GUIDE.md) for detailed guide
